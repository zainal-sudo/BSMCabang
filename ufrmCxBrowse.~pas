...
uses
  ...
  cxCurrencyEdit,ExcelXP,ComObj, dxSkinDarkRoom, dxSkinFoggy, dxSkinSeven,
  dxSkinSharp ;
...
//  ExportGridToExcel(AStream, cxGrid1, True);
//  AStream.SaveToFile('Employees.xls');
//  AStream.Free;


//  cxGrdMaster.ViewData.Expand(true);
//  if SaveDlg.Execute then
//    ExportGridToExcel(SaveDlg.FileName, cxGrid,True);
